...
static const Uint8 font_v1_data[] = {
...
static const struct inline_font font_v1_small = {
    .image_data = font_v1_data,
    .width = 470,            // Total bitmap width
    .height = 24,            // Total bitmap height
    .glyph_x = 7,            // Character width
    .glyph_y = 5,            // Character height
    .image_size = sizeof(font_v1_data)
};
